...
using WPFUISample.Models;

namespace WPFUISample.ViewModels.Pages
{
    public partial class DashboardViewModel : SearchViewModel<ItemModel, ObservableCollection<ItemModel>>
    {
